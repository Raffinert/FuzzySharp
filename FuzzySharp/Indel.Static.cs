...
public sealed partial class Indel
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static int DistanceImpl<T>(IPatternMatchVector<T> s1Vector, ReadOnlySpan<T> s2,
        int? scoreCutoff = null) where T : IEquatable<T>
    {
        var maximum = s1Vector.Length + s2.Length;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static double NormalizedDistanceImpl<T>(IPatternMatchVector<T> s1Vector, ReadOnlySpan<T> s2,
        int? scoreCutoff = null) where T : IEquatable<T>
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static double NormalizedSimilarityImpl<T>(IPatternMatchVector<T> s1Vector, ReadOnlySpan<T> s2,
        int? scoreCutoff = null) where T : IEquatable<T>
    {
