...
public sealed partial class Levenshtein
{
    ...
    private static int DistanceMultipleULongs<T>(
        IPatternMatchVector<T> sourceVector,
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    private static int DistanceMultipleULongsImpl<T>(IPatternMatchVector<T> sourceVector, ReadOnlySpan<T> target,
        int? scoreCutoff,
        int m,
        int blocks,
    ...
    private static int DistanceSingleULong<T>(IPatternMatchVector<T> sourceVector, ReadOnlySpan<T> target, int scoreCutoff) where T : IEquatable<T>
    {
        var m = sourceVector.Length;
