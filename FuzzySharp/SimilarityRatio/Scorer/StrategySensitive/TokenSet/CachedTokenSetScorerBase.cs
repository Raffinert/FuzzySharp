...
public abstract class CachedTokenSetScorerBase(ReadOnlySpan<char> input1) : ICachedRatioScorer
{
    private HashSet<string> Tokens1 { get; } = new(input1.SplitByAnySpace());
