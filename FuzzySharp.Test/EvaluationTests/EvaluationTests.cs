...
public class EvaluationTests
{
    ...
    public void Evaluate()
    {
        ...
        var g1 = Fuzz.TokenAbbreviationRatio("bl 420", "Baseline section 420", StringPreprocessors.Full);
        var g2 = Fuzz.PartialTokenAbbreviationRatio("bl 420", "Baseline section 420", StringPreprocessors.Full);
        ...
        var i1 = Process.ExtractOne("cowboys", ["Atlanta Falcons", "New York Jets", "New York Giants", "Dallas Cowboys"], StringPreprocessors.None, ScorerCache.Get<DefaultRatioScorer>());
